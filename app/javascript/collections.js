...
var $author$project$Collections$Editing = {$: 'Editing'};
var $author$project$Collections$InitAll = function (a) {
	return {$: 'InitAll', a: a};
};
var $elm$json$Json$Decode$decodeValue = _Json_run;
var $author$project$Collections$emptyEntered = function (flags) {
	return {address: '', boxes: 1, contact: flags.user_full_name, date: '', name: '', notes: '', phone: '', postcode: ''};
};
var $author$project$Collections$Flags = F6(
	function (user_full_name, user_email, contact_id, branch_id, branches, status) {
		return {branch_id: branch_id, branches: branches, contact_id: contact_id, status: status, user_email: user_email, user_full_name: user_full_name};
	});
var $author$project$Collections$Branch = F5(
	function (branch_id, name, address, postcode, phone) {
		return {address: address, branch_id: branch_id, name: name, phone: phone, postcode: postcode};
	});
...
var $author$project$Collections$branchDecoder = A6(
	$elm$json$Json$Decode$map5,
	$author$project$Collections$Branch,
	A2($elm$json$Json$Decode$field, 'branch_id', $elm$json$Json$Decode$int),
...
var $author$project$Collections$branchesDecoder = $elm$json$Json$Decode$list($author$project$Collections$branchDecoder);
var $elm$json$Json$Decode$map6 = _Json_map6;
var $author$project$Collections$flagsDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Collections$Flags,
	A2($elm$json$Json$Decode$field, 'user_full_name', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'user_email', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'contact_id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'branch_id', $elm$json$Json$Decode$int),
	A2($elm$json$Json$Decode$field, 'branches', $author$project$Collections$branchesDecoder),
...
var $author$project$Collections$init = function (flags_json) {
	var parsed_flags = function () {
		var _v1 = A2($elm$json$Json$Decode$decodeValue, $author$project$Collections$flagsDecoder, flags_json);
		if (_v1.$ === 'Err') {
			var err = _v1.a;
			return A2(
				$elm$core$Debug$log,
				$elm$core$Debug$toString(err),
				{branch_id: 0, branches: _List_Nil, contact_id: 0, status: 'Flags parse error', user_email: 'Flags parse error', user_full_name: 'Flags parse error'});
		} else {
			var flags = _v1.a;
			return flags;
		}
	...
	return _Utils_Tuple2(
		{
			...
			entered: $author$project$Collections$emptyEntered(parsed_flags),
			flags: parsed_flags,
			submissionStatus: $author$project$Collections$Editing,
			today: $elm$core$Maybe$Nothing
		},
		A2($elm$core$Platform$Cmd$map, $author$project$Collections$InitAll, datePickerCmd));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Collections$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$none;
};
var $author$project$Collections$Submission = {$: 'Submission'};
var $author$project$Collections$SubmissionFailure = function (a) {
	return {$: 'SubmissionFailure', a: a};
};
var $author$project$Collections$SubmissionSuccess = {$: 'SubmissionSuccess'};
var $author$project$Collections$TodaysDateReceived = function (a) {
	return {$: 'TodaysDateReceived', a: a};
};
...
var $author$project$Collections$resetEnteredBranch = function (model) {
	return _Utils_update(
		model,
		{
			entered: {address: '', boxes: model.entered.boxes, contact: model.entered.contact, date: model.entered.date, name: '', notes: model.entered.notes, phone: '', postcode: ''}
		});
};
var $author$project$Collections$SubmittedForm = function (a) {
...
var $author$project$Collections$formDataEncoder = function (model) {
	var e = model.entered;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'contact_id',
				$elm$json$Json$Encode$int(model.flags.contact_id)),
				_Utils_Tuple2(
				'branch_id',
				$elm$json$Json$Encode$int(model.flags.branch_id)),
				_Utils_Tuple2(
				'boxes',
				$elm$json$Json$Encode$int(e.boxes)),
				_Utils_Tuple2(
				'date',
				$elm$json$Json$Encode$string(e.date)),
				_Utils_Tuple2(
				'address',
				$elm$json$Json$Encode$string(e.address)),
				_Utils_Tuple2(
				'postcode',
				$elm$json$Json$Encode$string(e.postcode)),
				_Utils_Tuple2(
				'name',
				$elm$json$Json$Encode$string(e.name)),
				_Utils_Tuple2(
				'contact',
				$elm$json$Json$Encode$string(e.contact)),
				_Utils_Tuple2(
				'phone',
				$elm$json$Json$Encode$string(e.phone)),
				_Utils_Tuple2(
				'notes',
				$elm$json$Json$Encode$string(e.notes)),
				_Utils_Tuple2(
				'submitter_name',
				$elm$json$Json$Encode$string(model.flags.user_full_name)),
				_Utils_Tuple2(
				'submitter_email',
				$elm$json$Json$Encode$string(model.flags.user_email))
			]));
};
...
var $author$project$Collections$submitForm = function (model) {
	return $elm$http$Http$post(
		{
			body: $elm$http$Http$jsonBody(
				$author$project$Collections$formDataEncoder(model)),
			expect: $elm$http$Http$expectString($author$project$Collections$SubmittedForm),
			url: 'http://localhost:3000/collections/submit'
		});
};
var $author$project$Collections$dateFormat = 'E, d/MMM/yyyy';
...
var $author$project$Collections$settings = function () {
...
var $author$project$Collections$updateDatePicker = F2(
	function (datePickerCmd, model) {
		var newEntered = model.entered;
		var _v0 = A3($CurrySoftware$elm_datepicker$DatePicker$update, $author$project$Collections$settings, datePickerCmd, model.datePicker);
		...
		return _Utils_update(
			model,
			{
				...
				entered: _Utils_update(
					newEntered,
					{
						date: A2(
							$justinmimbs$date$Date$format,
							$author$project$Collections$dateFormat,
							A2(
								$elm$core$Maybe$withDefault,
								A3($justinmimbs$date$Date$fromCalendarDate, 1970, $elm$time$Time$Jan, 1),
								newDate))
					})
			});
	});
var $author$project$Collections$updateEnteredBranch = F2(
	function (model, branch) {
		return _Utils_update(
			model,
			{
				entered: {address: branch.address, boxes: model.entered.boxes, contact: model.entered.contact, date: model.entered.date, name: branch.name, notes: model.entered.notes, phone: branch.phone, postcode: branch.postcode}
			});
	});
var $author$project$Collections$updateTheRest = function (model) {
	var _v0 = model.flags.branches;
	if (!_v0.b) {
		return model;
	} else {
		if (_v0.b.b) {
			...
			var branch = _v0.a;
			return A2($author$project$Collections$updateEnteredBranch, model, branch);
		}
	}
};
var $author$project$Collections$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'InitAll':
				var datePickerCmd = msg.a;
				return _Utils_Tuple2(
					$author$project$Collections$updateTheRest(
						A2($author$project$Collections$updateDatePicker, datePickerCmd, model)),
					A2($elm$core$Task$perform, $author$project$Collections$TodaysDateReceived, $justinmimbs$date$Date$today));
			case 'TodaysDateReceived':
				var date = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'ToDatePicker':
				var subMsg = msg.a;
				return _Utils_Tuple2(
					A2($author$project$Collections$updateDatePicker, subMsg, model),
					$elm$core$Platform$Cmd$none);
			case 'PressedSubmit':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{submissionStatus: $author$project$Collections$Submission}),
					$author$project$Collections$submitForm(model));
			case 'SubmittedForm':
				var result = msg.a;
				return A2(
					$elm$core$Debug$log,
					'submitted ' + $elm$core$Debug$toString(result),
					function () {
						if (result.$ === 'Ok') {
							var r = result.a;
							return A2(
								$elm$core$Debug$log,
								'submited ' + $elm$core$Debug$toString(r),
								_Utils_Tuple2(
									_Utils_update(
										model,
										{submissionStatus: $author$project$Collections$SubmissionSuccess}),
									$elm$core$Platform$Cmd$none));
						} else {
							var string = result.a;
							return A2(
								$elm$core$Debug$log,
								'submited ' + $elm$core$Debug$toString(string),
								_Utils_Tuple2(
									_Utils_update(
										model,
										{
											submissionStatus: $author$project$Collections$SubmissionFailure(string)
										}),
									$elm$core$Platform$Cmd$none));
						}
					}());
			default:
				...
				return A2(
					...
					$elm$core$Debug$toString(
						_Utils_Tuple2('selecting branch', branch_id)),
					function () {
						var _v3 = $elm$core$List$head(
							A2(
								...
								function (branch) {
									return _Utils_eq(
										branch_id,
										$elm$core$String$fromInt(branch.branch_id));
								},
						...
						if (_v3.$ === 'Just') {
							...
							return A2(
								$elm$core$Debug$log,
								$elm$core$Debug$toString(
									_Utils_Tuple3('selected branch', branch_id, branch)),
								_Utils_Tuple2(
									A2($author$project$Collections$updateEnteredBranch, model, branch),
									$elm$core$Platform$Cmd$none));
						} else {
							return _Utils_Tuple2(
								$author$project$Collections$resetEnteredBranch(model),
								$elm$core$Platform$Cmd$none);
						}
					}());
		}
...
var $author$project$Collections$modelDebug = function (model) {
	return true ? A2(
		$elm$html$Html$p,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$elm$html$Html$text(
				'model debug will go here' + $elm$core$Debug$toString(model))
			])) : A2($elm$html$Html$span, _List_Nil, _List_Nil);
};
var $author$project$Collections$Address = {$: 'Address'};
var $author$project$Collections$Contact = {$: 'Contact'};
var $author$project$Collections$Name = {$: 'Name'};
var $author$project$Collections$Notes = {$: 'Notes'};
var $author$project$Collections$Phone = {$: 'Phone'};
var $author$project$Collections$Postcode = {$: 'Postcode'};
var $author$project$Collections$SetBoxes = function (a) {
	return {$: 'SetBoxes', a: a};
};
var $author$project$Collections$SetEntered = F2(
	function (a, b) {
		return {$: 'SetEntered', a: a, b: b};
	});
var $elm$html$Html$br = _VirtualDom_node('br');
var $author$project$Collections$PressedSubmit = {$: 'PressedSubmit'};
...
var $author$project$Collections$buttonAndSubmission = function (model) {
	...
	switch (_v0.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Collections$PressedSubmit)
							]),
						_List_fromArray(
							[
								$elm$html$Html$text('Submit Collection Request')
							]))
					]));
		case 'Submission':
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Submission in progress...')
							])),
						A2(
						$elm$html$Html$img,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('/images/ajax-loader.gif')
							]),
						_List_Nil)
					]));
		case 'SubmissionSuccess':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Order has been submitted')
					]));
		default:
			var err = _v0.a;
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						'Submission failure' + (' ' + $elm$core$Debug$toString(err)))
					]));
	}
};
var $author$project$Collections$ToDatePicker = function (a) {
...
var $author$project$Collections$dateValidation = F2(
	function (today, date) {
		if (today.$ === 'Nothing') {
			return 'We did not expect lack of today\'s date';
		} else {
			var todaysDate = today.a;
			var startDate = A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, 1, todaysDate);
			var endDate = A3($justinmimbs$date$Date$add, $justinmimbs$date$Date$Days, 31, todaysDate);
			if (date.$ === 'Nothing') {
				return 'please select date';
			} else {
				var pickedDate = date.a;
				return A3($justinmimbs$date$Date$isBetween, startDate, endDate, pickedDate) ? 'we have valid date' : 'Please pick valid date between 1 and 31 days from today';
			}
		}
	});
...
var $author$project$Collections$datePickerWidget = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						A2($author$project$Collections$dateValidation, model.today, model.date))
					])),
				function () {
				var _v0 = model.date;
				if (_v0.$ === 'Nothing') {
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Pick collection date')
							]));
				} else {
					var date = _v0.a;
					return A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								A2($justinmimbs$date$Date$format, $author$project$Collections$dateFormat, date))
							]));
				}
			}(),
				A2(
				$elm$html$Html$map,
				$author$project$Collections$ToDatePicker,
				A3($CurrySoftware$elm_datepicker$DatePicker$view, model.date, $author$project$Collections$settings, model.datePicker))
			]));
};
var $elm$html$Html$Attributes$max = $elm$html$Html$Attributes$stringProperty('max');
var $elm$html$Html$Attributes$min = $elm$html$Html$Attributes$stringProperty('min');
var $elm$html$Html$textarea = _VirtualDom_node('textarea');
var $author$project$Collections$SelectBranchOption = function (a) {
	return {$: 'SelectBranchOption', a: a};
};
var $elm$core$String$concat = function (strings) {
	return A2($elm$core$String$join, '', strings);
};
var $author$project$Collections$branchOptionString = function (branch) {
	return $elm$core$String$concat(
		_List_fromArray(
			[branch.name, ' - ', branch.address, ', ', branch.postcode, ' - ', branch.phone]));
};
var $author$project$Collections$compareBranchesForSort = F2(
	function (a, b) {
		return A2(
			$elm$core$Basics$compare,
			$author$project$Collections$branchOptionString(a),
			$author$project$Collections$branchOptionString(b));
	});
var $elm$html$Html$select = _VirtualDom_node('select');
var $elm$core$List$sortWith = _List_sortWith;
var $author$project$Collections$viewBranchSelector = function (model) {
	var _v0 = model.flags.branches;
	if (!_v0.b) {
		return A2(
			$elm$html$Html$p,
			...
			_List_fromArray(
				[
					$elm$html$Html$text('Error, we expect to see a branch here.')
				]));
	} else {
		if (!_v0.b.b) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onInput($author$project$Collections$SelectBranchOption)
							]),
						A2(
							$elm$core$List$cons,
							A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Please select the branch address...')
									])),
							A2(
								$elm$core$List$map,
								function (branch) {
									return A2(
										...
										_List_fromArray(
											[
												$elm$html$Html$text(
												$author$project$Collections$branchOptionString(branch))
											]));
								},
								A2($elm$core$List$sortWith, $author$project$Collections$compareBranchesForSort, model.flags.branches))))
					]));
		}
	}
};
var $author$project$Collections$viewValid = function (model) {
	var brSpanBr = function (wording) {
		return A2(
			$elm$html$Html$span,
			_List_Nil,
			_List_fromArray(
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('Please collect ')
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						$elm$html$Html$input,
						_List_fromArray(
							[
								...
								$elm$html$Html$Attributes$value(
								$elm$core$String$fromInt(model.entered.boxes)),
								$elm$html$Html$Attributes$min('1'),
								$elm$html$Html$Attributes$max('100'),
								$elm$html$Html$Events$onInput($author$project$Collections$SetBoxes)
							]),
						_List_Nil),
						A2(
						$elm$html$Html$span,
						...
						_List_fromArray(
							[
								$elm$html$Html$text(
								(model.entered.boxes === 1) ? 'box' : 'boxes')
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						$elm$html$Html$span,
						...
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$author$project$Collections$datePickerWidget(model),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						$author$project$Collections$viewBranchSelector(model),
						A2(
						$elm$html$Html$span,
						_List_Nil,
						_List_fromArray(
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'min-width', '25em'),
								$elm$html$Html$Attributes$value(model.entered.name),
								$elm$html$Html$Events$onInput(
								$author$project$Collections$SetEntered($author$project$Collections$Name))
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('collection address')
							])),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						A2(
						...
						_List_fromArray(
							[
								A2($elm$html$Html$Attributes$style, 'min-width', '35em'),
								A2($elm$html$Html$Attributes$style, 'min-height', '4em'),
								$elm$html$Html$Attributes$value(model.entered.address),
								$elm$html$Html$Events$onInput(
								$author$project$Collections$SetEntered($author$project$Collections$Address))
							]),
						_List_Nil),
						brSpanBr('postcode'),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(model.entered.postcode),
								$elm$html$Html$Events$onInput(
								$author$project$Collections$SetEntered($author$project$Collections$Postcode))
							]),
						_List_Nil),
						brSpanBr('contact'),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(model.entered.contact),
								$elm$html$Html$Events$onInput(
								$author$project$Collections$SetEntered($author$project$Collections$Contact))
							]),
						_List_Nil),
						brSpanBr('phone'),
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$value(model.entered.phone),
								$elm$html$Html$Events$onInput(
								$author$project$Collections$SetEntered($author$project$Collections$Phone))
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil),
						...
						_List_fromArray(
							[
								...
								A2($elm$html$Html$Attributes$style, 'min-height', '4em'),
								$elm$html$Html$Events$onInput(
								$author$project$Collections$SetEntered($author$project$Collections$Notes))
							]),
						_List_Nil),
						A2($elm$html$Html$br, _List_Nil, _List_Nil)
					])),
				$author$project$Collections$buttonAndSubmission(model)
			]));
};
var $author$project$Collections$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				$author$project$Collections$modelDebug(model),
				(model.flags.status === 'Ok') ? $author$project$Collections$viewValid(model) : A2(
				$elm$html$Html$p,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Invalid data detected. Please contact IT with your login information.')
					]))
			]));
};
var $author$project$Collections$main = $elm$browser$Browser$element(
	{init: $author$project$Collections$init, subscriptions: $author$project$Collections$subscriptions, update: $author$project$Collections$update, view: $author$project$Collections$view});
_Platform_export({'Collections':{'init':$author$project$Collections$main($elm$json$Json$Decode$value)(0)}});}(this));